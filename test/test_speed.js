 ...
 *   1MBPS:    47Kb/s  with Ack ,
 *   250Kbps:  16Kb/s  with Ack ,
 */
 ...
 //const rf24 = new nrf24.nRF24(24,0);
 const rf24 = new nrf24.nRF24(25,1);
 rf24.begin(false);
...
function snd() {
    ...
    buffer.fill('#');
    console.log("Start streaming with ", STREAM_SIZE/1024 , " buffer size");
